...
$$DV01=-\frac{P(y+0.01\%)-P(y-0.01\%)}{2}$$. This is similar to the **central difference** in finite difference methods to calculate for numerical differentiation, which results in lower  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjI0NTU3NTQwLDQxNzI4MTk4NCwzNDI0Mz
